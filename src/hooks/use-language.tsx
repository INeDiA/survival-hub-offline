...
const translations = {
  en: {
    ...
    templateEditorTrigger: "Edit templates",
    templateEditorTitle: "Starter template editor",
    templateEditorDescription: "Preview-only editor for the three onboarding templates.",
    templateEditorPreviewOnly: "Visible only in preview or local development.",
    templateEditorSave: "Save preview changes",
    templateEditorReset: "Reset defaults",
    templateEditorCopy: "Copy JSON",
    templateEditorIcon: "Icon",
    templateEditorNameEn: "Name (EN)",
    templateEditorNameIt: "Name (IT)",
    templateEditorSummaryEn: "Short description (EN)",
    templateEditorSummaryIt: "Short description (IT)",
    templateEditorDescriptionEn: "Full description (EN)",
    templateEditorDescriptionIt: "Full description (IT)",
    templateEditorNotesEn: "Notes (EN)",
    templateEditorNotesIt: "Notes (IT)",
    templateEditorAddItem: "Add item",
    templateEditorRemoveItem: "Remove",
    templateEditorItemLabel: (n: number) => `Item ${n}`,
    templateEditorSaveDone: "Preview template changes saved",
    templateEditorResetDone: "Default templates restored",
    templateEditorCopyDone: "Template JSON copied",
    templateEditorCopyFailed: "Unable to copy JSON",
    ...
    shareNotSupported: "Sharing not supported, downloading instead",
  ...
  it: {
    ...
    templateEditorTrigger: "Modifica template",
    templateEditorTitle: "Editor template iniziali",
    templateEditorDescription: "Editor disponibile solo in preview per i tre template di onboarding.",
    templateEditorPreviewOnly: "Visibile solo in preview o in sviluppo locale.",
    templateEditorSave: "Salva modifiche preview",
    templateEditorReset: "Ripristina default",
    templateEditorCopy: "Copia JSON",
    templateEditorIcon: "Icona",
    templateEditorNameEn: "Nome (EN)",
    templateEditorNameIt: "Nome (IT)",
    templateEditorSummaryEn: "Descrizione breve (EN)",
    templateEditorSummaryIt: "Descrizione breve (IT)",
    templateEditorDescriptionEn: "Descrizione completa (EN)",
    templateEditorDescriptionIt: "Descrizione completa (IT)",
    templateEditorNotesEn: "Note (EN)",
    templateEditorNotesIt: "Note (IT)",
    templateEditorAddItem: "Aggiungi oggetto",
    templateEditorRemoveItem: "Rimuovi",
    templateEditorItemLabel: (n: number) => `Oggetto ${n}`,
    templateEditorSaveDone: "Modifiche preview ai template salvate",
    templateEditorResetDone: "Template originali ripristinati",
    templateEditorCopyDone: "JSON dei template copiato",
    templateEditorCopyFailed: "Impossibile copiare il JSON",
    items: "oggetti",
    present: "presenti",
    sortBy: "Ordina per",
    category: "Categoria",
    ...
    movedToInBag: "Spostato nello zaino",
    ...
    shareSuccess: "Backup condiviso con successo",
    shareNotSupported: "Condivisione non supportata, scarico il file",
    ...
    cat_commsRadio: "Comms & Radio",
    cat_fireCooking: "Fuoco & Cucina",
    cat_foodWater: "Cibo e acqua",
    cat_hygiene: "Igiene",
    cat_lighting: "Illuminazione",
    cat_firstAid: "Primo Soccorso",
